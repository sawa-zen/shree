class Matrix4 extends Float32Array {
  ...
  multiplyMatrices(aMat: Matrix4, bMat: Matrix4): Matrix4 {
  ...
  translate(vec3: number[]) {
    this[12] = this[0] * vec3[0] + this[4] * vec3[1] + this[8]  * vec3[2] + this[12];
    this[13] = this[1] * vec3[0] + this[5] * vec3[1] + this[9]  * vec3[2] + this[13];
    this[14] = this[2] * vec3[0] + this[6] * vec3[1] + this[10] * vec3[2] + this[14];
    this[15] = this[3] * vec3[0] + this[7] * vec3[1] + this[11] * vec3[2] + this[15];
